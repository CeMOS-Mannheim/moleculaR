#' Find sodiated version of a lipid
#'
#' This function check if a sodiated version lipid is detectable in the MS data represented 
...
#' @export
#'
searchSodioLip      = function(m, fwhm, massAxis, spData, coords, 
