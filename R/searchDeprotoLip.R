#' Find deprotonated version of a lipid
#'
#' This function check if a deprotonated version lipid is detectable in the MS data represented 
#' by a sparse matrix (negative mode). 
#'
...
#' @param spData: the sparse matrix containing the negative ion mode info. 
...
#' @export
#'
searchDeprotoLip     = function(m, fwhm, massAxis, spData, coords, 
