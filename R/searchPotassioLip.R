#' Find potassiated version of a lipid
#'
#' This function check if a potassiated version lipid is detectable in the MS data represented 
...
#' @export
#'
searchPotassioLip      = function(m, fwhm, massAxis, spData, coords, 
...
# #// Na+ adduct ----
# lipTmp        = searchList$swissList[[lipidSpecies]]$`Exact m/z of [M+Na]+`[i]
# 
...
# #// K+ adduct ----
# lipTmp        = searchList$swissList[[lipidSpecies]]$`Exact m/z of [M+K]+`[i]
# 
# if(!is.na(lipTmp)) { # for example there is no Na-adduct version
#        
#        
